...
outliers = [13932,# "Christos_Faloutsos"
6770,#"Jiawei_Han"
# 455066,# "Charu_Agarwal"
# 793398,# "Philip_Yu"
14045,# "Jian_Pei"
144907,# "Bing_Liu"
1911# "Hans-Peter_Kriegel"
]
...
feature_pairs.remove(('DEST', 'EDGES_OUT'))
print feature_pairs
...
for i, plot in enumerate(plots):
    ...
    fname = 'discoveries/DBLP-{0}-{1}-{2}.png'.format(num_outlier, budget, i)
    fig.savefig(fname)
